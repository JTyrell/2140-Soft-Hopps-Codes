...
public class SummaryUI extends JFrame implements ActionListener, ItemListener
{
	...
	private final String GAME_STATS_FILE = "C:\\tmp\\GameStats.csv";
	...
	public void actionPerformed(ActionEvent event) 
	{
		try 
		{
		writer = new FileWriter(GAME_STATS_FILE, true);		
		...
		for (BasketballPlayer p : team) // loops through team members to update info
