/**
 * StatsMachineUI is the graphical user interface to track game stats
...
public class StatsMachineUI extends JFrame implements PlayerAlert, ActionListener, ItemListener
{
	...
	public StatsMachineUI()
	{
		
		super("Calabar Stats Tracker");
	 ...
	 */
	@Override
	public void alert(String title, String msg, String warn) 
	{	
	...
	public void loadPlayer()
	{
		...
		else
		{
	        ...
	        label.setFont(new Font("serif", Font.PLAIN, 20));
			JOptionPane.showMessageDialog(null, label, "Error",JOptionPane.WARNING_MESSAGE, null);
		}/*loop when roster seems to be too big*/
